...
def get_single_author(author_id: int, db: Session = Depends(get_db)) -> schemas.Author:
...
def get_books_by_author(author_id: int, db: Session = Depends(get_db)) -> schemas.Book:
